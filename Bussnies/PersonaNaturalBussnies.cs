...
namespace Bussnies
{
	public class PersonaNaturalBussnies : IPersonaNaturalBussnies
	{
		...
		private readonly IPersonaNaturalRepository personaNaturalRepository;

		/// <summary>
		/// 
		/// </summary>
		/// <param name="mapper"></param>
		public PersonaNaturalBussnies(IMapper mapper, IApisPeruServices apisPeruServices, IPersonaNaturalRepository personaNaturalRepository)
		{
			_mapper = mapper;
