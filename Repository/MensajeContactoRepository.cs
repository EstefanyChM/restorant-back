...
namespace Repository
{
	...
	{
		public MensajeContactoRepository(_dbRiccosContext _DbRiccosContext) : base(_DbRiccosContext)
		{
		}


		public async Task<Remite> CrearRemitente(Remite remite)
		{
			db.Remites.Add(remite);
